const TermsPage = () => {
  return (
    <div>
      ...
      <h2 className="text-center mt-4 text-2xl font-semibold">Last updated February 03, 2024 AGREEMENT TO OUR LEGAL</h2>
      
      <div className="w-full mt-14 flex justify-center">
        <p className="max-w-[1024px] leading-10">
          TERMS We are DevHub ("Company," "we," "us," "our" ). We operate the
          ...
          onboarding.devhub@gmail.com, as stated in the email message. By
          continuing to use the Services after the effective date of any
          changes, you agree to be bound by the modified terms. The Services are
          ...
          their parent or guardian to use the Services. If you are a minor, you
          must have your parent or guardian read and agree to these Legal Terms
          prior to you using the Services. We recommend that you print a copy of
          these Legal Terms for your records. TABLE OF CONTENTS 1. OUR SERVICES
          2. INTELLECTUAL PROPERTY RIGHTS 3. USER REPRESENTATIONS 4. USER
          REGISTRATION 5. PROHIBITED ACTIVITIES 6. USER GENERATED CONTRIBUTIONS
          7. CONTRIBUTION LICENSE 8. GUIDELINES FOR REVIEWS 9. SOCIAL MEDIA 10.
          SERVICES MANAGEMENT 11. PRIVACY POLICY 12. COPYRIGHT INFRINGEMENTS 13.
          TERM AND TERMINATION 14. MODIFICATIONS AND INTERRUPTIONS 15. GOVERNING
          LAW 16. DISPUTE RESOLUTION 17. CORRECTIONS 18. DISCLAIMER 19.
          LIMITATIONS OF LIABILITY 20. INDEMNIFICATION 21. USER DATA 22.
          ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES 23. CALIFORNIA
          USERS AND RESIDENTS 24. MISCELLANEOUS 25. CONTACT US 1. OUR SERVICES
          ...
          Gramm-Leach-Bliley Act (GLBA). 2. INTELLECTUAL PROPERTY RIGHTS Our
          intellectual property We are the owner or the licensee of all
          ...
          purpose whatsoever, without our express prior written permission. If
          ...
          address your request to: onboarding.devhub@gmail.com. If we ever grant
          ...
          will terminate immediately. Your submissions and contributions Please
          review this section and the "PROHIBITED ACTIVITIES " section carefully
          ...
          us a license (including use of your name, trademarks, and logos): By
          ...
          license includes our use of your name, company name, and franchise
          name, as applicable, and any of the trademarks, service marks, trade
          names, logos, and personal and commercial images you provide. You are
          ...
          extent permissible by applicable law, waive any and all moral rights
          to any such Submission and/or Contribution; warrant that any such
          ...
          Contributions do not constitute confidential information. You are
          ...
          immediately refer to the " COPYRIGHT INFRINGEMENTS " section below. 3.
          USER REPRESENTATIONS By using the Services, you represent and warrant
          ...
          minor, you have received parental permission to use the Services ; (6)
          you will not access the Services through automated or non-human means,
          whether through a bot, script or otherwise; (7) you will not use the
          ...
          portion thereof). 4. USER REGISTRATION You may be required to register
          to use the Services. You agree to keep your password confidential and
          ...
          inappropriate, obscene, or otherwise objectionable. 5. PROHIBITED
          ACTIVITIES You may not access or use the Services for any purpose
          other than that for which we make the Services available. The Services
          ...
          the Services, you agree not to: Systematically retrieve data or other
          ...
          any revenue-generating endeavor or commercial enterprise. Sell or
          otherwise transfer your profile. Use the Services to advertise or
          offer to sell goods and services. 6. USER GENERATED CONTRIBUTIONS The
          ...
          suspension of your rights to use the Services. 7. CONTRIBUTION LICENSE
          ...
          notice. We have no obligation to monitor your Contributions. 8.
          ...
          account. 10. SERVICES MANAGEMENT We reserve the right, but not the
          ...
          the proper functioning of the Services. 11. PRIVACY POLICY We care
          about data privacy and security. Please review our Privacy Policy:
          https://www.termsfeed.com/live/414949fc-210f-4a9d-9b36-8ee212f5508d .
          ...
          Services are hosted in Kosovo . If you access the Services from any
          ...
          applicable laws in Kosovo , then through your continued use of the
          Services, you are transferring your data to Kosovo , and you expressly
          consent to have your data transferred to and processed in Kosovo .
          ...
          Services as quickly as is reasonably practical. 12. COPYRIGHT
          INFRINGEMENTS We respect the intellectual property rights of others.
          ...
          in a Notification. Thus, if you are not sure that material located on
          or linked to by the Services infringes your copyright, you should
          consider first contacting an attorney. 13. TERM AND TERMINATION These
          ...
          pursuing civil, criminal, and injunctive redress. 14. MODIFICATIONS
          AND INTERRUPTIONS We reserve the right to change, modify, or remove
          ...
          discontinuance of the Services. We cannot guarantee the Services will
          be available at all times. We may experience hardware, software, or
          ...
          releases in connection therewith. 15. GOVERNING LAW These Legal Terms
          shall be governed by and defined following the laws of Kosovo . DevHub
          and yourself irrevocably consent that the courts of Kosovo shall have
          ...
          these Legal Terms, including any question regarding its existence,
          ...
          Prishtina, Kosovo . The language of the proceedings shall be Albanian.
          The governing law of these Legal Terms shall be substantive law of
          Kosovo . Restrictions The Parties agree that any arbitration shall be
          ...
          to the personal jurisdiction of that court. 17. CORRECTIONS There may
          ...
          the information on the Services at any time, without prior notice. 18.
          DISCLAIMER THE SERVICES ARE PROVIDED ON AN AS-IS AND AS-AVAILABLE
          ...
          EXERCISE CAUTION WHERE APPROPRIATE. 19. LIMITATIONS OF LIABILITY IN NO
          ...
          ADDITIONAL RIGHTS. 20. INDEMNIFICATION You agree to defend, indemnify,
          ...
          to or arising out of: (1) your Contributions; (2) use of the Services;
          ...
          is subject to this indemnification upon becoming aware of it. 21. USER
          DATA We will maintain certain data that you transmit to the Services
          ...
          or corruption of such data. 22. ELECTRONIC COMMUNICATIONS,
          TRANSACTIONS, AND SIGNATURES Visiting the Services, sending us emails,
          ...
          to you electronically, via email and on the Services, satisfy any
          ...
          credits by any means other than electronic means. 23. CALIFORNIA USERS
          ...
          24. MISCELLANEOUS These Legal Terms and any policies or operating
          ...
          hereto to execute these Legal Terms. 25. CONTACT US In order to
          resolve a complaint regarding the Services or to receive further
          information regarding use of the Services, please contact us at:
          DevHub onboarding.devhub@gmail.com These terms of use were created
        </p>
      </div>
    </div>
  );
