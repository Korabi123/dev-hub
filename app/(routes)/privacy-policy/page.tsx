...
const PrivacyPolicyPage = () => {
  return (
    <>
      ...
      <div className={cn("page", poppins.className)}>
        <div className="header">
          <div className="container">
            <p className="title">Privacy Policy for DevHub</p>
          </div>
        </div>
          ...
          <div className="container">
            ...
            >
              ...
              <ul className="list-disc">
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to DevHub, accessible from{" "}
                    <a
                      href="https://dev-hub-korabii.vercel.app"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://dev-hub-korabii.vercel.app
                    </a>
                  </p>
                </li>
                <li>
              ...
              <ul className="list-disc px-14 mb-4">
                <li>Google</li>
                <li>Facebook</li>
                <li>Instagram</li>
                <li>Twitter</li>
              ...
              <ul>
                <li>By email: onboarding.devhub@gmail.com</li>
              </ul>
            </div>
          </div>
        </div>
