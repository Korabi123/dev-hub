...
export const PasswordResetEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Hi {name}, We noticed a recent attempt to reset your DevHub account password. If this was you</Preview>
      <Body style={main}>
        <Container>
          <Section style={content}>
            ...
            <Row style={{ ...boxInfos, paddingBottom: '0' }}>
              <Column>
                ...
                >
                  We noticed a recent attempt to reset your DevHub account password.
                </Heading>
