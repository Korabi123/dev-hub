...
export const TwoFactorEmail = ({ token, name }: TwoFactorEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>Hi {name}, We noticed a recent attempt to login to your DevHub account. If this was you</Preview>
      <Body style={main}>
        <Tailwind>
          <Container>
            <Section style={content}>
              ...
              <Row style={{ ...boxInfos, paddingBottom: "0" }}>
                <Column>
                  ...
                  >
                    We noticed a recent attempt to login to your DevHub account. If this was you, please enter the following code to complete the login process.
                  </Heading>
