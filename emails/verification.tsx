...
export const VerificationEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>Hi {name}, We noticed a recent attempt to Register for a DevHub account with your email. If this was you</Preview>
      <Body style={main}>
        <Container>
          <Section style={content}>
            ...
            <Row style={{ ...boxInfos, paddingBottom: '0' }}>
              <Column>
                ...
                >
                  We noticed a recent attempt to Register for a DevHub account with your email.
                </Heading>
